...
export const POOL_REGISTRY: Record<Chain, Record<TokenId, PoolEntry[]>> = {
  arbitrum: {
    usdc: [
      ...
      { address: '0x0000000000000000000000000000000000000000', token: 'usdc', denomination: '10000000000', label: '10,000 USDC', chain: 'arbitrum' },
      { address: '0x0000000000000000000000000000000000000000', token: 'usdc', denomination: '100000000000', label: '100,000 USDC', chain: 'arbitrum' },
      { address: '0x0000000000000000000000000000000000000000', token: 'usdc', denomination: '1000000000000', label: '1,000,000 USDC', chain: 'arbitrum' },
    ],
    usdt: [
      ...
      { address: '0x0000000000000000000000000000000000000000', token: 'usdt', denomination: '10000000000', label: '10,000 USDT', chain: 'arbitrum' },
      { address: '0x0000000000000000000000000000000000000000', token: 'usdt', denomination: '100000000000', label: '100,000 USDT', chain: 'arbitrum' },
      { address: '0x0000000000000000000000000000000000000000', token: 'usdt', denomination: '1000000000000', label: '1,000,000 USDT', chain: 'arbitrum' },
    ],
    dai: [
      ...
      { address: '0x0000000000000000000000000000000000000000', token: 'dai', denomination: '10000000000000000000000', label: '10,000 DAI', chain: 'arbitrum' },
      { address: '0x0000000000000000000000000000000000000000', token: 'dai', denomination: '100000000000000000000000', label: '100,000 DAI', chain: 'arbitrum' },
      { address: '0x0000000000000000000000000000000000000000', token: 'dai', denomination: '1000000000000000000000000', label: '1,000,000 DAI', chain: 'arbitrum' },
    ],
  },
  tron: {

  ...
  if (!connected) {
    return (
      <button
        ...
        className="cyberpunk-connect text-[13px] font-bold px-3 py-1.5 hover:transform hover:scale-105 transition-all duration-300 min-h-[36px]"
      >
        <span className="relative tracking-wider">CONNECT</span>
      </button>
    )
  }

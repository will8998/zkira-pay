  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        className="flex items-center gap-1.5 px-2 py-1.5 bg-[var(--color-hover)] border border-[var(--color-border)] hover:bg-[var(--color-skeleton)] hover:border-[#FFFFFF] transition-all duration-200 text-[12px]"
                ...
                return (
                  <button
                    ...
                    className={`w-full flex items-center gap-3 px-4 py-2.5 text-sm transition-colors ${
                      active
                        ? 'text-[#FFFFFF] bg-[var(--color-hover)]'
                  ...
                  >
                    ...
                    {active && (
                      <svg className="w-4 h-4 text-[#FFFFFF]" fill="currentColor" viewBox="0 0 20 20">
